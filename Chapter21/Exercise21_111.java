...
public class Exercise21_111 extends Application {
  ...
  public void findRanking() {
    ...
    if (gender.equals("Male")) {
      if (mapForBoy[year - 2001].containsKey(name)) {
        lblResult.setText("Boy name " + name + " is ranked " + mapForBoy[year - 2001].get(name) + " in year " + year);
      
      }  else { 
          lblResult.setText("Boy name " + name + " is not ranked in year " + year);
      }
    } else {
      if (mapForGirl[year - 2001].containsKey(name)) {
        lblResult.setText("Girl name " + name + " is ranked " + mapForGirl[year - 2001].get(name) + " in year " + year);
      
      } else { 
          lblResult.setText("Girl name " + name + " is not ranked in year " + year);
      }
    }
  }
